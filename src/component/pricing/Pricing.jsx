    ...
    <section className="pricing container section">
      ...
      <div className="pricing__container grid">
        <div className="pricing__item">
          ...
          <p className="pricing__title">Unlimited producct including
          ...
          <p className="pricing__title">A wise option for large companies and individual</p>
